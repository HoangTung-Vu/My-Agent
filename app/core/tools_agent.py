...
class ToolsAgent : 
    ...
    async def select_tool(self, query: str, recent_chat_history : List[BaseMessage]):
    ...
    async def run_tool(self, tool_call: Dict[str, Any]):
        ...
        try:
            # Run synchronous tool.invoke in a separate thread
